...
test('Complete portal workflow', async ({ page }) => {
  ...
  (await page.getByPlaceholder('Enter part number').fill('W11660283'), await page.getByPlaceholder('Enter postal code').fill('M1B 5K7'), await page.getByRole('button', { name: 'Search' }).click());
  ...
  (await page.getByPlaceholder('Enter part number').fill('14124124'), await page.getByPlaceholder('Enter postal code').fill('M1B 5K7'), await page.getByRole('button', { name: 'Search' }).click());
